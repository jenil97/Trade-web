  ...
  return (
    <div className="w-full bg-black text-white text-center">
      <div className="max-w-[1240px] mx-auto px-4 py-16 ">
        <div>
          <h1 className="py-4 text-3xl font-Raleway cursor-default">
            A Growing Protocol Ecosystem
          </h1>
          <p className="py-4 text-lg md:text-2xl font-Raleway cursor-default">
            This protocol system empowers developers , liquidity providers , and
            traders to participate in a financial marketplace that is open and
            accessible to all .
          </p>

          {/* Card Container */}
          <div className="grid sm:grid-cols-2 lg:grid-cols-4 gap-5 mt-10 cursor-default font-Raleway">
            {/* Card */}
            <AboutCard
